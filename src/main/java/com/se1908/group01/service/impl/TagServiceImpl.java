...
@Service
/**
 * Manages user-owned tags and the document_tag join rows used after an upload.
 */
public class TagServiceImpl implements TagService {
	...
	@Override
	/**
	 * Links an existing user-owned tag to an existing user-owned active document.
	 * This is called after upload because the document id is generated by the upload transaction.
	 */
	public TagResponse addTagToDocument(Long documentId, Long tagId) {
		...
		if (!documentTagRepository.existsByDocumentDocumentIdAndTagTagId(document.getDocumentId(), tag.getTagId())) {
			// Avoid duplicate rows in the document_tag many-to-many join table.
